<script>
				jQuery(function($) {
					  ...
					  var arrjumlah_ret = [];
					  $("td.jumlah_ret").each(function() { arrjumlah_ret.push($(this).autoNumeric('get')) });
						var total = 0;
						for (var i = 0; i < arrjumlah_ret.length; i++) {
							total += arrjumlah_ret[i] << 0;
							// alert(arrjumlah_ret[i]);
						};
					  $('.total_ret').autoNumeric('set',total);
					  $('.pemb_ret').autoNumeric('set',Math.ceil(total / 1000) * 1000);
