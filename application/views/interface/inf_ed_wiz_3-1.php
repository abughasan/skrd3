...
<input type="hidden" value="<?=$angka?>" name="tabel_ke"/>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="ket_fungsi<?=$angka?>" id="ket_fungsi<?=$angka?>" class="col-xs-12 col-sm-9" readonly="true" value="<?=$int_idmfungsi_ket->row()->keterangan?>" />
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="if_fix_<?=$angka?>" id="if_fix_<?=$angka?>" class="col-xs-12 col-sm-4" readonly="true"  value="<?=$int->row()->indeks_fungsi?>" />
																	</div>
																</div>
															</div>
...
<h3 class="lighter block blue">1.2.2 INDEKS KLASIFIKASI</h3>
																	...
																	<div class="clearfix">
																		<table class="table table-striped table-bordered table-hover"> 
																			...
																			<tr>
																				...
																				<td><input class="indeksparamsub" id="indeksparamsub<?=$no?>_<?=$angka?>" name="indeksparamsub_<?=$angka?>" type="text" value="<?=$$k->row()->indeks?>"></td>
																				<td><input class="bobotxindeks" name="bobotxindeks_<?=$angka?>" id="bobotxindeks<?=$no?>_<?=$angka?>" type="text" value="<?=$$k->row()->boboxindeks?>"><input id="bobotxindeks_hide<?=$no?>_<?=$angka?>" type="hidden"  value="<?=$$k->row()->boboxindeks?>"></td>
																			</tr>
																			<?php endforeach; ?>
																		</table>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="iklas_fix_<?=$angka?>" id="iklas_fix_<?=$angka?>" class="col-xs-12 col-sm-4" readonly="true" value="<?=$int->row()->total_indeks_klas?>" />
																		<input type="hidden" id="iklas_fix_hide<?=$angka?>" value="<?=$int->row()->total_indeks_klas?>" />
																	</div>
																</div>
															</div>
															<div class="space-2"></div>															
<h3 class="lighter block blue">1.2.3 WAKTU PENGGUNAAN</h3>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="ket_waktuguna<?=$angka?>" id="ket_waktuguna<?=$angka?>" class="col-xs-12 col-sm-9" readonly="true" value="<?=$int_idwg_ket->row()->keterangan?>"/>
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="iwg_fix_<?=$angka?>" id="iwg_fix_<?=$angka?>" class="col-xs-12 col-sm-4" readonly="true"  value="<?=$int->row()->indeks_waktuguna?>" />
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-10">
																	...
																	<table class="table table-striped table-bordered table-hover">
																		...
																		<tr>
																			<td><input id="if_fix2_<?=$angka?>" name="if_fix2_<?=$angka?>" type="text" value="<?=$int->row()->indeks_fungsi?>"></td>
																			<td>x</td>
																			<td><input id="iklas_fix2_<?=$angka?>" name="iklas_fix2_<?=$angka?>" type="text" value="<?=$int->row()->total_indeks_klas?>"></td>
																			<td>x</td>
																			<td><input id="iwg_fix2_<?=$angka?>" name="iwgfix2_<?=$angka?>" type="text" value="<?=$int->row()->indeks_waktuguna?>"></td>
																			<td>=</td>
																			<td><input id="indeks_integritas_<?=$angka?>" name="indeks_integritas_<?=$angka?>" type="text" value="<?=$int->row()->indeks_integritas?>"></td>
																		</tr>
																	</table>
