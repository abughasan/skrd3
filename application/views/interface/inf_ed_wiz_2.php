														...
														<form class="form-horizontal" id="validation-form2" method="get">
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="jenis_b" id="jenis_b" class="col-xs-12 col-sm-4" value="<?=$dbangunan->row()->jenis_bangunan?>"/>
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" id="lokasi_b" name="lokasi_b" class="col-xs-12 col-sm-6" value="<?=$dbangunan->row()->lokasi?>" />
																	</div>
																</div>
															</div>
															...
															<div class="form-group kecamatan2-group">
																...
																<div class="col-xs-12 col-sm-9">
																	...
																	<option value="">&nbsp;</option>
																	<?php foreach($kecamatan_cilegon as $row): ?>
																		<option value="<?=$row->kecamatan_id?>"  <?=(($dbangunan->row()->kecamatan_id==$row->kecamatan_id) ? 'selected' : '')?>><?=$row->kecamatan_name?></option>
																	<?php endforeach; ?>
																	</select>
																</div>
															</div>
